...
test.describe('SupplierStatementView Comprehensive 4-Axes Audit & Multi-Viewport Verification', () => {
    ...
    for (const vp of viewports) {
        test(`should render Supplier Statement ledger correctly on ${vp.name}`, async ({ page }) => {
            ...
            await page.goto('/suppliers/1/statement', { waitUntil: 'networkidle' });
