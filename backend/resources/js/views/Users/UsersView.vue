            ...
            <tbody class="divide-y divide-slate-200 dark:divide-slate-800/60 font-mono">
              <tr v-for="u in users" :key="u.id" class="hover:bg-slate-100 dark:hover:bg-slate-900/40 transition">
                <td class="p-4 font-sans font-bold text-slate-900 dark:text-white flex items-center gap-3">
                  <div class="w-8 h-8 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-theme-primary font-bold">
                    {{ u.name.charAt(0) }}
                  </div>
                  <div>
                ...
                <td class="p-4 text-end font-sans">
                  <div class="flex items-center justify-end gap-2">
                    <button
                      ...
                      class="p-1.5 bg-slate-900 hover:bg-slate-800 text-theme-primary border border-slate-700 rounded-lg transition cursor-pointer"
                      :title="$t('common.edit')"
                    >
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl max-w-lg w-full p-6 shadow-2xl space-y-4">
          <div class="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-3">
            <h2 class="text-base font-black text-white flex items-center gap-2">
              <UserPlus class="w-4 h-4 text-theme-primary" />
          ...
          <form @submit.prevent="submitForm" class="space-y-3.5 text-xs font-tajawal">
            ...
            <div class="flex items-center gap-2 pt-1">
              <input
                ...
                type="checkbox"
                id="is_active_check"
                class="w-4 h-4 rounded bg-slate-900 border-slate-700 text-theme-primary focus:ring-theme-primary"
              />
