<template>
  <Teleport to="body">
    <Transition name="fade">
      <div
        v-if="isModalOpen"
        class="fixed inset-0 bg-slate-950/85 backdrop-blur-md z-[100000] flex items-center justify-center p-4 select-none font-tajawal"
        dir="rtl"
      >
        <Transition name="modal-zoom">
          <div
            v-if="isModalOpen"
            class="bg-slate-900 border border-slate-700/80 rounded-3xl shadow-2xl max-w-md w-full overflow-hidden text-slate-100 relative"
          >
            ...
            <div class="p-6 space-y-4 text-xs">
              ...
              <div v-if="isDownloading" class="space-y-2 pt-2">
                ...
                <div class="w-full h-2.5 bg-slate-800 rounded-full overflow-hidden p-0.5 border border-slate-700">
                  <div
                    class="h-full bg-gradient-to-r from-amber-500 via-amber-400 to-emerald-500 rounded-full transition-all duration-200 shadow-md shadow-amber-500/50"
